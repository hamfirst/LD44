...
GLOBAL_ASSET(EntityResourcePtr, "./Entities/NPC1.entity", g_NPC1Entity);
GLOBAL_ASSET(EntityResourcePtr, "./Entities/NPC2.entity", g_NPC2Entity);
GLOBAL_ASSET(EntityResourcePtr, "./Entities/NPC3.entity", g_NPC3Entity);
GLOBAL_ASSET(EntityResourcePtr, "./Entities/NPC4.entity", g_NPC4Entity);

GLOBAL_ASSET(SpritePtr, "./Sprites/Alert.sprite", g_AlertSprite);
