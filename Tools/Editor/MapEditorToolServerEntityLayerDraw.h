...
class MapEditorToolServerEntityLayerDraw : public MapEditorToolBase
{
public:
  MapEditorToolServerEntityLayerDraw(MapEditor & map_editor, int layer_index, czstr ServerObject_file);
